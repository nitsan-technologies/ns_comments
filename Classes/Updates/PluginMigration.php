...
namespace Nitsan\NsComments\Updates;
...
#[UpgradeWizard('txNsCommentsPluginMigration')]
class PluginMigration implements UpgradeWizardInterface
{
    ...
    private const PLUGIN_MAPPINGS = [
        'nscomments_comment' => 'nscomments_comment',
    ];

    public function getTitle(): string
    {
        return 'EXT:ns_comments: Migrate legacy plugin to CType';
    }

    public function getDescription(): string
    {
        $count = $this->getTotalMigrationCount();
        return 'Migrates legacy Comments plugin records from CType=list + list_type=nscomments_comment to CType=nscomments_comment. '
