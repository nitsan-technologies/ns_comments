#
# Table structure for table 'tx_nscomments_domain_model_comment'
#
CREATE TABLE tx_nscomments_domain_model_comment (
...
CREATE TABLE pages (
	...
	nscomments  int(11) unsigned DEFAULT '0' NOT NULL,
